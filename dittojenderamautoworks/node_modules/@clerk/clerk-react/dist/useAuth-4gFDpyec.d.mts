...
declare const SignedIn: ({ children }: React.PropsWithChildren<unknown>) => React.JSX.Element | null;
declare const SignedOut: ({ children }: React.PropsWithChildren<unknown>) => React.JSX.Element | null;
declare const ClerkLoaded: ({ children }: React.PropsWithChildren<unknown>) => React.JSX.Element | null;
declare const ClerkLoading: ({ children }: React.PropsWithChildren<unknown>) => React.JSX.Element | null;
