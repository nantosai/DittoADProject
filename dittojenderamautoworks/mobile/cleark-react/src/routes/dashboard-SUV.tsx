...
const DashboardPage = () => {
  ...
  const carDetails = {
    category: 'SUV',
    imageUrl: '/CategoryA-SUV.png', // Replace this with your actual car image URL
    models: [
      ...
      <div className="max-w-lg w-full bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="bg-gray-50 shadow-md rounded-lg p-6 relative">
          ...
          <div>
            ...
            <h4 className="text-gray-600">KEMBARA, ATIVA & DLL</h4>
        ...
        <div className="bg-gray-50 shadow-md rounded-lg p-6 relative">
          <h2 className="text-xl font-bold mb-2">{carDetails.category}</h2>
          <img
            src={'/CategoryB-SUV.png'}
            alt="Car"
            className="w-full h-48 object-cover rounded mb-4"
          />
          <div>
            <h3 className="font-semibold">Category B</h3>
            <h4 className="text-gray-600">HARRIER & DLL</h4>
            <ul className="mt-4 space-y-2">
              {carDetails.models.map((model) => (
                <li
                  key={model.name}
