...
const DashboardPage = () => {
  ...
  const carDetails = {
    category: 'MPV',
    imageUrl: '/CategoryA-MPV.png', // Replace this with your actual car image URL
    models: [
      ...
      {/* Category Tabs */}
        ...
        <div className="bg-gray-50 shadow-md rounded-lg p-6 relative">
          ...
          <div>
            ...
            <h4 className="text-gray-600">ALZA, AVANZA & DLL</h4>
        ...
        <div className="bg-gray-50 shadow-md rounded-lg p-6 relative">
          <h2 className="text-xl font-bold mb-2">{carDetails.category}</h2>
          <img
            src={'/CategoryB-MPV.png'}
            alt="Car"
            className="w-full h-48 object-cover rounded mb-4"
          />
          <div>
            <h3 className="font-semibold">Category B</h3>
            <h4 className="text-gray-600">VELLFIRE, ALPHARD & DLL</h4>
            <ul className="mt-4 space-y-2">
              {carDetails.models.map((model) => (
                <li
                  key={model.name}
